              ...
              <div class="row g-5 center">
                  <div class="col-md-12 col-lg-6 col-xl-7">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                          <div class="form-item w-100">
                              ...
                              <input type="text" class="form-control" placeholder="아이디 입력" id="id" v-model="memberInfo.member_id" readonly>
                          </div>
                    ...
                    <div class="form-item col-lg-6">
                        ...
                        <input type="text" class="form-control" placeholder="이름 입력" id="name" v-model="memberInfo.member_name">
                    </div>
                    <div class="form-item col-lg-6 my-3">
                        <label class="bold">휴대전화<sup>*</sup></label>
                        <input type="text" class="form-control" placeholder="'-'없이 숫자만 입력" id="phone" v-model="memberInfo.member_phone">
                    </div>
                    <div class="form-item col-lg-6 my-3">
                        <label class="bold">이메일<sup>*</sup></label>
                        <input type="text" class="form-control" placeholder="이메일 입력 (예시 : email@example.com)" id="email" v-model="memberInfo.member_email">
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="form-item w-100">
                                <label class="bold">생년월일<sup></sup></label>
                                <input type="text" class="form-control" placeholder="생년월일 8자리 (예시 : 19000101)" id="birth" v-model="memberInfo.birthday">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                            <div class="form-item w-100">
                    ...
                    <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                        <button type="button" class="btn btn-primary2 border-secondary py-3 px-4 text-uppercase w-100" @click="memberUpdate()">정보수정</button>
                    </div><br>
                </div>
            </div>
        </form>
  ...
  export default {
    //   name: 'SignUp',
      ...
      methods : {
          ...
          async getMemberInfo() {
            let result = await axios.get(`/api/admin/memberInfo/${this.member_code}`)
                        .catch(err => console.log(err));
